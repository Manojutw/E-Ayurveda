...
<section class="footer-w3layouts-bottem py-lg-4 py-md-3 py-sm-3 py-3">
          ...
          <div class="bottom-para ">
            <div class="footer-office-hour">
              ...
              <ul>
                ...
                <li>
                  <p>
                    <a href="manojku.226@gmail.com">@mailto manojku.226@gmail.com</a>
                  </p>
                </li>
                <li class="my-2">
                  <h6>Admin</h6>
                ...
                <li>
                  <p>
                    <a href="../Ayurveda/index.php">@admin login</a>
                  </p>
                </li>
              </ul>
            </div>
  ...
  <footer class="bottem-wthree-footer text-center py-md-4 py-3">
    <p>
      © 2021 Ayurvedic Store. All Rights Reserved | Design by Manoj
      <a href="aisectuniversityjharkhand.ac.in" target="_blank">AISECT University</a>
